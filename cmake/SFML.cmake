if (MSVC)
    ...
    if (NOT EXISTS ${CMAKE_BINARY_DIR}/SFML-${SFML_VERSION}/)
        message(STATUS "[kode] Downloading SFML ${SFML_VERSION}")
        ...
        message(STATUS "[kode] Using cached SFML")
    endif ()
    ...
    if (CMAKE_BUILD_TYPE STREQUAL "Debug")
        ...
        message(STATUS "[kode] Copying SFML debug DLLs to ${CMAKE_RUNTIME_OUTPUT_DIRECTORY}")
        ...
        message(STATUS "[kode] Copying SFML release DLLs to ${CMAKE_RUNTIME_OUTPUT_DIRECTORY}")
