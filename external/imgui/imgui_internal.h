...
struct ImGuiContext {
  ...
  ImVector<ImGuiWindow*>
      WindowsFocusOrder;  // Windows, sorted in focus order, back to front.
                          // (FIXME: We could only store root windows here! Need
                          // to sort out the Docking equivalent which is
  ...
  ImGuiWindow*
      HoveredRootWindow;  // == HoveredWindow ? HoveredWindow->RootWindow :
                          // NULL, merely a shortcut to avoid null test in some
                          // situation.
  ImGuiWindow*
